    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView  == null){
         viewHolder = new ViewHolder();
            ...
            viewHolder.txtTenLaptop = convertView.findViewById(R.id.txtlaptop);
            viewHolder.txtGiaLaptop = convertView.findViewById(R.id.txtgialaptop);
            viewHolder.txtMoTaLaptop = convertView.findViewById(R.id.txtmotalaptop);
